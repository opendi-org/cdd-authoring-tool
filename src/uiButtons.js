...
export class SaveButton extends FunctionButton {
    /**
     * @param {Array<any>} args Needs: Original JSON, current rects map, current links array, original JSON elements map
    ...
    saveCallback(originalJSON, rects, links, elementsJSONMap)
    {
        fileIO.saveGraphJSON(originalJSON, rects, links, elementsJSONMap);
    }
}