...
/**
 * Constructs a diagram element map out of the full JSON for a causal decision model.
...
/**
 * Constructs a map from element UUID to a set of information about all dependencies associated with that
...
/**
 * Constructs a function map out of the full JSON for a causal decision model.
 * @param model Schema-compliant JSON for a causal decision model
...
/**
 * Constructs a control map out of the full JSON for a causal decision model.
